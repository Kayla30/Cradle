...
* **Performance Optimization:** Profiled material instruction counts, texture sample limits, and particle draw calls using Unreal's Shader Complexity view mode and RenderDoc.
